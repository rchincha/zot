...
func (ec *executionContext) _Query_search(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNSearchResult2ᚕgithubᚗcomᚋanuvuᚋzotᚋpkgᚋextensionsᚋsearchᚐSearchResultᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNSearchResult2githubᚗcomᚋanuvuᚋzotᚋpkgᚋextensionsᚋsearchᚐSearchResult(ctx context.Context, sel ast.SelectionSet, v SearchResult) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNSearchResult2ᚕgithubᚗcomᚋanuvuᚋzotᚋpkgᚋextensionsᚋsearchᚐSearchResultᚄ(ctx context.Context, sel ast.SelectionSet, v []SearchResult) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSearchResult2githubᚗcomᚋanuvuᚋzotᚋpkgᚋextensionsᚋsearchᚐSearchResult(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {

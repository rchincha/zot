...
test:
	...
	$(shell sudo chmod a=rwx /etc/containers/certs.d/127.0.0.1:8088/*.key)
	$(shell sudo mkdir -p /etc/containers/certs.d/127.0.0.1:8091/; sudo chmod a=rwx /etc/containers/certs.d/127.0.0.1:8091/;)
...
test-clean:
	...
	$(shell sudo rm -rf /etc/containers/certs.d/127.0.0.1:8091/)
